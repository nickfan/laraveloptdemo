 ...
 * Generated for Laravel 5.1.46 (LTS) on 2017-07-04.
 *
...
namespace Fahri5567\Minify\Facades { 
    ...
    class MinifyFacade {
         ...
         * @static 
         */ 
        public static function javascript($file, $attributes = array())
        {
            return \Fahri5567\Minify\Minify::javascript($file, $attributes);
        }
         ...
         * @static 
         */ 
        public static function stylesheet($file, $attributes = array())
        {
            return \Fahri5567\Minify\Minify::stylesheet($file, $attributes);
        }
        ...
        {
            return \Fahri5567\Minify\Minify::stylesheetDir($dir, $attributes);
        }
         ...
         * @static 
         */ 
        public static function javascriptDir($dir, $attributes = array())
        {
            return \Fahri5567\Minify\Minify::javascriptDir($dir, $attributes);
        }
         ...
         * @static 
         */ 
        public static function withFullUrl()
        {
            return \Fahri5567\Minify\Minify::withFullUrl();
        }
        ...
        {
            return \Fahri5567\Minify\Minify::onlyUrl();
        }
...
namespace  { 
    ...
    class Minify extends \Fahri5567\Minify\Facades\MinifyFacade {}
