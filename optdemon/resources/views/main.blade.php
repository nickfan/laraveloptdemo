...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="/assets/plugins/html5shiv/3.7.3/html5shiv.min.js"></script>
    <script src="/assets/plugins/respond.js/1.4.2/respond.min.js"></script>
    <![endif]-->
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="http://optdemon.com/main">OptNMain</a> </li>
                                ...
                                <li><a href="http://optdemoy.com/main">OptYMain</a> </li>
